...
const Contact = () => {
  ...
  return (
    <section id="contact" className="flex justify-center items-center bg-conic-300 from-primary to-background w-full p-4 min-h-screen">
      <div className="w-full h-full md:px-10 px-5">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-10 mt-16">
          <div className="xl:col-span-5">
            ...
            <div className="
              flex justify-center items-center rounded-xl p-10
            ...
            ">
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    className="
                      ...
                      bg-white/5 text-text placeholder-gray-400
                ...
                <button
                  type="submit"
                  className="
                    bg-primary py-3 px-6 rounded-lg font-bold text-lg text-white uppercase tracking-wider
